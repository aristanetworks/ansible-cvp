...
A [complete end-to-end demo](https://github.com/arista-netdevops-community/ansible-avd-cloudvision-demo) using [Arista AVD](https://avd.arista.com) and CloudVision modules is available as an example.
