...
from tests.data.device_tools_unit import (validate_router_bgp,
    validate_intf, validate_true, device_data,
...
class TestValidateConfig():
    ...
    @pytest.mark.parametrize("validate_mode, expected_calls",
        ...
        pytest.param(
            ModuleOptionValues.VALIDATE_MODE_STOP_ON_ERROR, EXP_WARN_ERROR_IGNORE, id="warning_stop_on_error"
        ),
        pytest.param(
            ModuleOptionValues.VALIDATE_MODE_IGNORE, EXP_WARN_ERROR_IGNORE, id="warning_skip"
        ),
        ])
    ...
    @pytest.mark.parametrize("validate_mode, expected_calls",
        ...
        pytest.param(
            ModuleOptionValues.VALIDATE_MODE_IGNORE, EXP_ERROR_IGNORE, id="error_skip"
        ),
        ])
